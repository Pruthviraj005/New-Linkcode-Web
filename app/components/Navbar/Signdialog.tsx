    ...
    return (
        <>
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <div className='hidden md:block bg-sky-50 p-2 rounded-lg'>
                    <button type="button" className='text-15px font-medium space-links hover:text-green-700' onClick={openModal}>
                        Sign In
                    </button>
                </div>
            </div>
                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                                        <div className="w-full max-w-md space-y-8">
                                            <h1 className='text-right -mt-12 -mr-2 text-gray-500 font-semibold text-xl cursor-pointer hover:text-gray-600' onClick={closeModal}>&times;</h1>
                                            <div>
                                            ...
                                            <form className="mt-8 space-y-6" action="#" method="POST">
                                                ...
                                                <div className="-space-y-px rounded-md shadow-sm">
                                                    <div>
                                                        ...
                                                        <p className='text-black pb-2 pl-1'>Email</p>
                                                        <input
                                                            id="email-address"
                                                            name="email"
                                                            type="email"
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className='text-black pb-2 pl-1 mt-6'>Password</p>
                                                        <input
                                                            id="password"
                                                            name="password"
                                                            type="password"
